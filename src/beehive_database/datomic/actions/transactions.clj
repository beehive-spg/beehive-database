...
(doseq [hive (clojure.edn/read-string (slurp "data.edn"))]
   (add-hive (:building/address hive) (:building/xcoord hive) (:building/ycoord hive) (:hive/name (:building/hive hive))))
